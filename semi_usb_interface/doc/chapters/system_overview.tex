...
\begin{subfigure}[b]{0.65\linewidth}
    \includegraphics[width=\linewidth]{figures/IIP_semiUSB_N1_charge_top_print.png}
    \caption{Nº1 board top view.}
  \end{subfigure}
  \begin{subfigure}[b]{0.65\linewidth}
    \includegraphics[width=\linewidth]{figures/IIP_semiUSB_N1_charge_bottom_print.png}
    \caption{Nº1 board bottom view.}
  \end{subfigure}
\begin{subfigure}[b]{0.65\linewidth}
    \includegraphics[width=\linewidth]{figures/IIP_semiUSB_N2_RBF_top_print.png}
    \caption{Nº2 board top view.}
  \end{subfigure}
  \begin{subfigure}[b]{0.65\linewidth}
    \includegraphics[width=\linewidth]{figures/IIP_semiUSB_N2_RBF_bottom_print.png}
    \caption{Nº2 board bottom view.}
  \end{subfigure}
\begin{subfigure}[b]{0.65\linewidth}
    \includegraphics[width=\linewidth]{figures/IIP_semiUSB_N3_QuadUART_top_print.png}
    \caption{Nº2 board top view.}
  \end{subfigure}
  \begin{subfigure}[b]{0.65\linewidth}
    \includegraphics[width=\linewidth]{figures/IIP_semiUSB_N3_QuadUART_bottom_print.png}
    \caption{Nº2 board bottom view.}
  \end{subfigure}
    \caption{IIP Semi USB full set.}
    \label{fig:IIP_Semi_USB_full_set}
\end{figure}
