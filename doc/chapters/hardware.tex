...
IIP is designed to be mouted vertically on the sides of a 2U or 3U CubeSat structure and provide all the minimal features for AIT. In the following sections, the hardware design, external and internal connectors, the FT4232H IC and test points are described in detail. On \autoref{fig:iip-all-boards} is displayed top and bottom PCB prints of all boards.

\begin{figure}[!h]
\centering     %%% not \center
\subfigure[IIP Nº1 "Charge" top]{\label{fig:a}\includegraphics[width=75mm]{figures/iip_n1_top.png}}
\subfigure[IIP Nº1 "Charge" bottom]{\label{fig:b}\includegraphics[width=75mm]{figures/iip_n1_bottom.png}}
\subfigure[IIP Nº2 "RBF" top]{\label{fig:a}\includegraphics[width=75mm]{figures/iip_n2_top.png}}
\subfigure[IIP Nº2 "RBF" bottom]{\label{fig:b}\includegraphics[width=75mm]{figures/iip_n2_bottom.png}}
\subfigure[IIP Nº3 "Quad UART" top]{\label{fig:a}\includegraphics[width=75mm]{figures/iip_n3_top.png}}
\subfigure[IIP Nº3 "Quad UART" bottom]{\label{fig:b}\includegraphics[width=75mm]{figures/iip_n3_bottom.png}}
\subfigure[IIP Nº4 "Closure" variant top]{\label{fig:a}\includegraphics[width=75mm]{figures/iip_n4_closure_top.png}}
\subfigure[IIP Nº4 "Closure" variant bottom]{\label{fig:b}\includegraphics[width=75mm]{figures/iip_n4_closure_bottom.png}}
\subfigure[IIP Nº4 "Camera" variant top]{\label{fig:a}\includegraphics[width=75mm]{figures/iip_n4_camera_top.png}}
\subfigure[IIP Nº4 "Camera" variant bottom]{\label{fig:b}\includegraphics[width=75mm]{figures/iip_n4_camera_bottom.png}}
\caption{IIP fullset of boards.}
\label{fig:iip-all-boards}
\end{figure}
...
Components size and positioning were decided for conforming with the CubeSat 2U standard of maximum connector height on the sides of the P-POD structure \cite{p-pod-user-guide} and to a specific project scenario using SpaceLab's core modules for the FloripaSat-2 mission \cite{floripasat2}.
...
\begin{table}[!h]
    ...
    \begin{tabular}{cllll}
        ...
        TP6                & (VCCIO) I/O interface 3V3 power supply input. \\
        TP7                & (PWREN\#) Active low power-enable output. \\
        TP8                & (SUSPEND\#) Active low when USB is in suspend mode. \\
        TP9                & (GND) 0V ground input for FT4232H.\\
        \bottomrule[1.5pt]
    \end{tabular}
...
\section{M12 Camera Lens Mount}

On IIP Nº4 variant camera board has a center hole to serve as an opening for an M12 camera lens, the other two holes are for mouting the ArduCam MT9D111 rev.B. breakout board, as seen in \autoref{fig:arducam}. On \autoref{fig:n4-mec} is displayed the PCB mouting hole distances and sizes for the camera.

\begin{figure}[!ht]
  \centering
    \subfigure[]{\label{fig:a}\includegraphics[width=75mm]{figures/ArduCam_MT9D111_top.png}}
    \subfigure[]{\label{fig:b}\includegraphics[width=55mm]{figures/ArduCam_MT9D111_bottom.png}}
    \caption{ArduCam MT9D111 rev.B.}
    \label{fig:arducam}
\end{figure}

\begin{figure}[!ht]
\centering
    \includegraphics[width=0.75\linewidth]{figures/iip_n4_camera_mec_specs.png}
    \caption{IIP Nº4 Camera variant mechanical dimensions.}
    \label{fig:n4-mec}
\end{figure}
