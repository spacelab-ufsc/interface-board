...
Connecting a type A to mini type B USB cable to a PC and the USB port present on IIP Nº3, the four USB to UART channels should be ready to be used. Note that the computer will recognize the port as four different devices. The IIP Nº3 doesn't have an EEPROM, so it will be already configured to operate as default serial ports. The FT4232H will have the built-in default VID (0403) and PID (6011).