...
\bibliography{references/interface-board-repo,references/p-pod-user-guide,references/floripasat2,references/ftdi-usb-hardware-guidelines,references/cubesat-design-specification,references/ftdi-ft4232h-datasheet,references/iip-draftsman}
