...
IIP board Nº1 is to be mouted vertically inside the 2U strucuture on the -X referenced plane. IIP board Nº3 is to be mouted in the same plane of reference but in the other side, that is the +X plane. IIP board Nº2 is to be mouted on the -Y plane. The integration order of the interface panels follows their numeration, this means the first PCB to be integrated is Nº1, than Nº2 and at last Nº3. The internal PicoBlade connections to the modules must be done before proceding to mount the other panels.
