...
IIP is to be mouted vertically inside on the side of a 2U CubeSat structure, this makes de Nº1 and Nº3 boards having the same PCB dimentions because they are on the same X plane of reference, see figure \ref{fig:iip-n1-n3-dimensions}. The Nº2 board dimenstion can be seen in figure \ref{fig:iip-n2-dimensions}. The "structure contact area" is the place where the metal frame of the CubeSat structure will be overlapping. All other measurements important to integration and assembly are present in the draftsman PDF documents of each board here \cite{iip-draftsman} on GitHub.
